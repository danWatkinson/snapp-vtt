  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        ".features-gen/apps/web/tests/e2e/**",   // exclude generated Playwright/BDD artifacts
        ...
        "apps/services/assets/app.ts",           // Express wiring/glue for assets service (covered via app.test.ts)
        "apps/services/assets/server.ts",        // Assets service bootstrap/server wiring
