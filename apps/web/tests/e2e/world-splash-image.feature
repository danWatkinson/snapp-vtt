Feature: World builder sets a splash image for a world
  ...
  Scenario: World builder sets a splash image for a world and it appears in the header and selector
    ...
    And the world selector shows a splash thumbnail for "Eldoria" using "approaching-nuln.jpg"
